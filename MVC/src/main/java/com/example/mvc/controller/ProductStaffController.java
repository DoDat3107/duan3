...
@WebServlet(name = "ProductStaffController", value = "/productsStaff")
public class ProductStaffController extends HttpServlet {
    ...
    private static final Logger LOGGER = Logger.getLogger(ProductStaffController.class.getName());
    ...
    private void showHome(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        List<Category> categoryList = categoryService.findAll(); // Lấy danh sách tất cả danh mục
        categorizeSubcategories(request, categoryList);

        request.setAttribute("categoryList", categoryList);
        RequestDispatcher dispatcher = request.getRequestDispatcher("/static/products/homeStaff.jsp");
    ...
    private void categorizeSubcategories(HttpServletRequest request, List<Category> categoryList) {
        ...
        // Lặp qua các danh mục để phân loại
        ...
        // Đặt các danh sách phụ kiện vào request để sử dụng trong JSP
