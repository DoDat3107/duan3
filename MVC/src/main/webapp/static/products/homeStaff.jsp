...
<div class="container">
    ...
    <div class="menu">
        <div class="box">
            <div class="select"><a href="<c:url value='/productsStaff'/>">Tất cả</a></div>
                ...
                <div class="dropdown">
                    <c:forEach var="category" items="${categoryList}">
                        <c:if test="${category.name.toLowerCase().contains('áo')}">
                            <a href="<c:url value='/productsStaff?action=search&searchCategory=${category.name}'/>">${category.name}</a>
                        </c:if>
                    </c:forEach>
                </div>
            </div>
        ...
        <div class="box2">
            <div class="search">
                <form action="<c:url value='/productsStaff'/>" method="get">
        ...
        <div class="login">
            <a href="<c:url value='/categories?action=home'/>" class="login-btn">Menu Loại</a>
            <a href="<c:url value='/menuUser?action=home'/>" class="login-btn">Menu tài khoản</a>
    ...
    <div class="shop">
        <table border="1">
            <tr>
                <th colspan="8"><h1>Danh sách sản phẩm</h1></th>
            </tr>
            <tr>
                <th>Id</th>
                <th>Name</th>
                ...
                <th >Action</th>
                <th >
                    <button class="login-btn" ><a href="/productsStaff?action=create">Thêm mới</a></button></th>
            </tr>
            ...
            <c:forEach var="item" items="${productList}">
                <tr>
                    ...
                    <td><button class="login-btn"><a href="<c:url value='/productsStaff?action=edit&id=${item.id}'/>">Edit</a></button></td>
                    <td><button class="login-btn"><a href="<c:url value='/productsStaff?action=delete&id=${item.id}'/>">Delete</a></button></td>
                </tr>
            </c:forEach>
        </table>
    </div>
